...
import org.test.toolkit.ssh.command.Command;
import org.test.toolkit.ssh.command.Cp;
import org.test.toolkit.ssh.command.Grep;
import org.test.toolkit.ssh.command.GroupCommandFactory;
import org.test.toolkit.ssh.command.GroupCommands;
import org.test.toolkit.ssh.command.Iptable;
import org.test.toolkit.ssh.command.Ls;
import org.test.toolkit.ssh.command.Mkdir;
import org.test.toolkit.ssh.command.Sed;
import org.test.toolkit.ssh.command.Tail;
import org.test.toolkit.ssh.command.Touch;
import org.test.toolkit.util.CollectionUtils;
...
public abstract class AbstractServerOperations implements ServerOperations {
	...
	public void blockConnections(boolean isOutput, String atLeastOneIp, String... otherIps) {
		List<String> allIps = CollectionUtils.getList(atLeastOneIp, otherIps);
